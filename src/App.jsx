            ...
            <BorderGlow {...BORDER_GLOW_PROPS} className="home-trust-glow">
              <div className="home-trust-panel">
                ...
                <p>
                  ...
                  <strong>我们成立社团的初心，是探索一种更贴近真实世界的大学学习新范式！</strong><br />
                  我们不把绩点和考试视为大学成长的全部，<br />
                  而是希望借助社团的教学与资源，帮助社员走进企业、接触行业，逐步形成自己的学习方式与实践能力！<br />
                  我们以<strong>公益教学</strong>为核心，希望帮助每一位真正想学习 AI 的同学找到起点，<br />
